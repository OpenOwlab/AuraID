export const PROVIDERS = {
  openai: {
    ...
    name: "OpenAI",
    models: [
      { id: "gpt-5.2-chat-latest", name: "GPT-5.2", contextWindow: 256000, supportsImages: true },
      { id: "gpt-4.1", name: "GPT-4.1", contextWindow: 1047576, supportsImages: true },
      { id: "gpt-4.1-mini", name: "GPT-4.1 Mini", contextWindow: 1047576, supportsImages: true },
      { id: "gpt-4.1-nano", name: "GPT-4.1 Nano", contextWindow: 1047576, supportsImages: true },
      { id: "gpt-4o", name: "GPT-4o", contextWindow: 128000, supportsImages: true },
      { id: "gpt-4o-mini", name: "GPT-4o Mini", contextWindow: 128000, supportsImages: true },
      { id: "o3", name: "o3", contextWindow: 200000, supportsImages: true },
      { id: "o3-mini", name: "o3 Mini", contextWindow: 200000, supportsImages: true },
      { id: "o4-mini", name: "o4 Mini", contextWindow: 200000, supportsImages: true },
    ],
  ...
  moonshot: {
    ...
    name: "Moonshot",
    models: [
      { id: "moonshotai/Kimi-K2.5", name: "Kimi K2.5-Custom", contextWindow: 256000, supportsImages: true},
...
export function modelSupportsImages(providerId: string, modelId: string): boolean {
  const provider = PROVIDERS[providerId as ProviderId];
  if (!provider) return true;
  const model = provider.models.find((m) => m.id === modelId);
  if (!model) return true;
  const flag = (model as { supportsImages?: boolean }).supportsImages;
  // 默认支持图片，只有显式标记 supportsImages: false 时才认为不支持
  return flag !== false;
}
