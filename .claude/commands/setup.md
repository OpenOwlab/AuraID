---
description: Interactive setup wizard for AuraID. Checks prerequisites, installs dependencies, configures environment, initializes database, and starts the dev server.
allowed-tools:
  - Bash(node --version)
  - Bash(node -e:*)
  - Bash(npm --version)
...
You are an interactive setup assistant for the AuraID project. Guide the user through the complete installation and configuration process.
